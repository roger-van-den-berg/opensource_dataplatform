...
echo ""
echo "  Next steps:"
echo "    1. Deploy the lakehouse platform:"
echo "       cd /home/user/opensource_dataplatform/ansible"
echo "       ansible-playbook 260206_deploy_all_lakehouse_rb_v1_0.yaml"
echo ""
echo "    2. Check platform health:"
echo "       bash /home/user/opensource_dataplatform/ansible/health_check.sh"
echo ""
echo -e "${BOLD}============================================${NC}"
